    ...
    <div className="container px-5 my-5 py-3 my-container">
      <div className="row">
        ...
        <div className="col-12">
          <h1 className="fw-bold title-search px-4">Cerca il tuo gioco preferito</h1>
          <input 
            class="input"
            name="text"
            type="text"
          ...
          <div className="container py-5 px-5">
            <div className="row">
              ...
              {searchTerm && filteredGames.length === 0 && (
                <p className="text-center fw-bold">Nessun gioco trovato per "{searchTerm}"</p>
              )}
                ...
                <div className="d-flex flex-wrap">
                  {filteredGames.map((game) => (
                    <div key={game.id}  className="col-3">
                            ...
                            <div className="col-5 flip-card mx-5 my-5 flip-in-hor-bottom" key={game.id}>
