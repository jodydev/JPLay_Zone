              ...
              <div className="row">
                <div className="col-12 col-md-6">
                  <div className="container slide-in-left d-none d-lg-block">
                    <img src="/assets/img/sponsor/klarna.avif" height="170" className="rounded-5 w-100 shadow-lg transition" alt="Klarna" />
                  </div>
                </div>                
                <div className="col-12 col-md-6 d-none d-lg-block">
                  <div className="container slide-in-right ">
                    <img src="/assets/img/sponsor/klarna-info.webp" height="170" className="rounded-5 w-100 shadow-lg transition" alt="Klarna Info" />
                  </div>
                </div>
              </div>
            </div>
